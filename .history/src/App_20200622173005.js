...
export class App extends Component {
  ...
  AmqpReturn(frame) {
    ...
    if (obj.OnlineUser != null && obj.OnlineCount > this.OnlineCount) {
      _this.OnlineCount = obj.OnlineCount;
    }
  }
  test() {
    const { cookies } = this.props;
    if (client.connected == true && this.Subscribe == false) {
      let loginName = cookies.get('loginState');
    ...
    this.OnlineCount += 1;
    var obj = { OnlineUser: loginName, OnlineCount: this.OnlineCount };
